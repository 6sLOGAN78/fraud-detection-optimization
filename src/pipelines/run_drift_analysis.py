"""Pipeline script to run Drift Analysis — Part 3.15."""
...
def main() -> None:
    ...
    # Define paths
    report_dir = Path("reports/eda/drift")
    ...
    # Initialize and run DriftAnalyzer
    ...
    logger.info("Executing Drift Analysis pipeline stages...")
    analyzer.analyze_all(report_dir=report_dir)

    logger.info("Drift Analysis pipeline stage completed successfully.")
